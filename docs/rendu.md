...
10. Bootstrap sudo durci: etapes non-systeme sous utilisateur appelant + normalisation ownership/permissions finales et bit executable de tous les lanceurs `.sh` pour eviter les blocages `Permission non accordee` au lancement borne.

...
class TestOperationsMaintenance(unittest.TestCase):
    ...
    def test_lister_operations_masque_les_options_10_et_11(self) -> None:
        """Controle le retrait des anciennes options 10 et 11.
        ...
        self.assertNotIn("mise_a_jour_os", identifiants)
        self.assertEqual(
            identifiants,
            [
                "diagnostic",
                ...
                "git_pull",
                "git_retour_precedent",
                "pipeline_post_pull",
            ],
        )
        self.assertIn("git_retour_precedent", identifiants)
        self.assertEqual(len(identifiants), 9)
